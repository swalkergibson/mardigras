 ...
 */
class Inventory extends \Entities\Inventory implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setInventoryPieces(\Entities\InventoryPieces $inventoryPieces)
    {
        $this->__load();
        return parent::setInventoryPieces($inventoryPieces);
    }

    public function getInventoryPieces()
    {
        $this->__load();
        return parent::getInventoryPieces();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'sku', 'description', 'shortDescription', 'quantity', 'lastCost', 'price', 'vendorStock', 'sizeId', 'minQuantity', 'doNotOrder', 'online', 'vendor', 'category', 'orderItems', 'inventoryPieces');
    }
