 ...
 */
class InvoiceItems extends \Entities\InvoiceItems implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setInvoice(\Entities\Invoices $invoice)
    {
        $this->__load();
    ...
    public function setInvoiceItems(\Entities\InvoiceItemsPieces $invoiceItemPieces)
    {
        $this->__load();
        return parent::setInvoiceItems($invoiceItemPieces);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'price', 'rentalRate', 'discount', 'quantity', 'taxExempt', 'dateOut', 'dateDue', 'dateReturned', 'daysCharged', 'invoice', 'inventory', 'invoiceItemPieces');
    }
