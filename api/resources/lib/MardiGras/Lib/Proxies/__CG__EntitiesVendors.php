 ...
 */
class Vendors extends \Entities\Vendors implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'code', 'name', 'contact', 'address1', 'address2', 'cityState', 'city', 'state', 'zip', 'phone', 'fax', 'email', 'mgAccountNum', 'salesRepName', 'salesRepPhone', 'orders', 'inventoryItems');
    }
