 ...
 */
class ClerkGroupPermissions extends \Entities\ClerkGroupPermissions implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::arrayFy($level, $ignore);
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'slug', 'title', 'permissionAssignments');
    }
