 ...
 */
class Orders extends \Orders implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'orderDate', 'lastUpdateDate', 'orderKey', 'cancelDate', 'shipDate', 'orderDiscount', 'paymentTerms', 'deliveryDate', 'submitDate', 'orderStatus', 'orderSubmitMethod', 'vendor', 'clerk');
    }
