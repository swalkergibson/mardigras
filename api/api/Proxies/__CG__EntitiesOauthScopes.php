 ...
 */
class OauthScopes extends \Entities\OauthScopes implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'scope', 'name', 'description', 'sessionScopes');
    }
