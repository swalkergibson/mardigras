 ...
 */
class ClerkGroupPermissionsAssign extends \ClerkGroupPermissionsAssign implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setClerkGroupPermissions($clerkGroupPermissions);
    }

    public function getClerkGroupPermissions()
    {
        $this->__load();
        return parent::getClerkGroupPermissions();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'allow', 'deny', 'clerkGroup', 'clerkGroupPermissions');
    }
