 ...
 */
class Invoices extends \Invoices implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'transactionDate', 'saleTotal', 'tax', 'balanceDue', 'rentDep', 'depositCard', 'depositCardExp', 'clerk', 'invoiceStatus', 'depositMethod', 'customer');
    }
