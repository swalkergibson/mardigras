 ...
 */
class OauthSessions extends \OauthSessions implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'clientId', 'redirectUri', 'ownerType', 'ownerId', 'accessToken', 'authCode', 'refreshToken', 'accessTokenExpires', 'stage', 'firstRequested', 'lastUpdated');
    }
